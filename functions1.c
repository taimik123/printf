...
/**
 * print_unsigned - code for Prints an unsigned number
 * @types: code for List a of arguments
 * @buffer: code to Buffer array to handle print
 * @flags:  code which Calculates active flags
 * @width: code to get width
 * @precision: code to Precision specification
 * @size: code Size specifier
 * Return: code Number of chars printed.
 */
...
/**
 * print_octal - this code Prints an unsigned number in octal notation
